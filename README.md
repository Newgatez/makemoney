...
<head>
    ...
    <title>Painel 10 Janelas Ultra Rápido</title>
    ...
    <style>
        ...
        /* Estilo simplificado: quanto menos efeitos visuais complexos, mais rápida a renderização */
        .janela {
            width: 100%;
            height: 100%;
            border: 1px solid #222;
            border-radius: 4px;
            background: #1a1a1a; /* Fundo escuro enquanto carrega evita o "piscar" branco */
            box-sizing: border-box;
        }
